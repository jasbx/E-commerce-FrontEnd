               ...
               className="bg-white shadow-md border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
                <div className="flex  flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    <>
                        ...
                        <button onClick={()=>setMenu(!openMenu)} data-collapse-toggle="mobile-menu-2" type="button" className="inline-flex space-x-10 m-5 md:m-0 md:space-x-0 items-center p-2 ml-1 text-sm text-gray-500 rounded-lg  hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mobile-menu-2" aria-expanded="false">
